<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-digits1742/1?page=1&difficulty=Basic&status=unsolved&sortBy=submissions">Sum Of Digits</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a number <strong>n</strong>. Find the sum of all the digits of n.</span></p>
